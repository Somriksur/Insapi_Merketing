      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="lg:sticky lg:top-6 self-start">
          <div className="bg-white text-black p-8 shadow-2xl" style={{ minHeight: 800 }}>
            {/* Derive invoice accent color from org settings */}
            {(() => {
              const invColor = org.invoice_color || "#0B0B0B";
              return (
                <>
            <div className="flex justify-between items-start gap-4 pb-4" style={{ borderBottom: `2px solid ${invColor}` }}>
              <div className="flex items-center gap-3">
                <LogoMark settings={org} className="w-12 h-12" alt="logo" />
                <div>
                  <p className="font-bold text-2xl tracking-tight" style={{ color: invColor, fontFamily: "'Outfit', sans-serif" }}>{org.name}</p>
            ...
            <table className="w-full mt-8 text-xs">
              <thead>
                <tr style={{ background: invColor, color: "white" }}>
            ...
            <div className="flex justify-end mt-6">
              <div className="w-64 space-y-1 text-xs">
                ...
                <div className="flex justify-between pt-2 mt-2 font-bold" style={{ borderTop: `1px solid ${invColor}` }}>
